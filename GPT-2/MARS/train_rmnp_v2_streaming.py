...
# optimizer
from optimizers.rmnp_v2 import RMNP_v2
...
# optimizer2 = RMNP_v2([p for p in params if p.ndim == 2], lr=rmnp_learning_rate, rank=ddp_rank, world_size=ddp_world_size)
# optimizers = [optimizer1, optimizer2]
optimizer = CombinedOptimizer(params, [AdamW, RMNP_v2], [{'lr': learning_rate, 'betas': (beta1, beta2), 'weight_decay': weight_decay},
