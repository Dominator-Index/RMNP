...
RUN_NAME="rmnp_v2-xl-${DATASET_SHORT}-lr${LR}-rlr${RMNP_LR}-b1_${BETA1}-b2_${BETA2}-wd${WD}-rwd${RMNP_WD}-it${MAX_ITERS}"
# Log file
...
torchrun --standalone --nproc_per_node=${GPUS} \
      MARS/train_rmnp_v2_streaming.py \
      config/train_gpt2_xl_rmnp_v2_streaming_fw.py \
